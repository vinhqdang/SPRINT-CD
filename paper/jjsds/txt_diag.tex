...
the $25$ wrong arrowheads occur on pairs with an incomplete block. Where the
block is complete, the rate is inside budget in both strata.
...
$95\%$ intervals and the direction budget $\alpha_D$. The exceedance lives
entirely in the incomplete-block bar on the premise-failing
stratum.}\label{fig:exp11}
\end{figure}

Figure~\ref{fig:exp11} plots the four cells against the budget.
